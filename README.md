...
📄 **[Especificación OpenAPI (YAML)](github.com/DWS-2026/project-grupo-13/blob/main/demo/api-docs/api-docs.yaml)**

#### **Documentación HTML**
📖 **[Documentación API REST (HTML)](github.com/DWS-2026/project-grupo-13/blob/main/demo/api-docs/api-docs.html)**
