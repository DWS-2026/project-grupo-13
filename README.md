...
| Nº    | Commits      | Files      |
|:------------: |:------------:| :------------:|
|1| [OrderController.java](URL_commit_1)  | [Archivo1](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Controller/OrderController.java)   |
|2| [WebSecurity.java](URL_commit_2)  | [Archivo2](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Security/WebSecurityConfig.java)   |
|3| [Order.java](URL_commit_3)  | [Archivo3](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Model/Order.java)   |
|4| [OrderItem.java](URL_commit_4)  | [Archivo4](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Model/OrderItem.java)   |
|5| [ImageController.java](URL_commit_5)  | [Archivo5](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Controller/ImageController.java)   |
...
#### **Alumno 4 - Hugo García Tapia**

Desarrollo de los formularios para editar categorías y productos. Foto de perfil para los usuarios. Actualización de la página de promociones. Cambio de contraseña del usuario.

| Nº    | Commits      | Files      |
|:------------: |:------------:| :------------:|
|1| [Editar Categorías](URL_commit_1)  | [Archivo1](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Controller/AdminCategoryController.java)   |
|2| [Editar Producto](URL_commit_2)  | [Archivo2](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Controller/AdminProductController.java)   |
|3| [Cambiar Contraseña](URL_commit_3)  | [Archivo3](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Controller/UserController.java))   |
|4| [Foto de Perfil](URL_commit_4)  | [Archivo4](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/resources/templates/EditProfile.html)   |
|5| [Página de Promociones](URL_commit_5)  | [Archivo5](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/resources/templates/PromotionsScreen.html)   |
...
### **Vídeo de Demostración**
📹 **[Enlace al vídeo en YouTube]([https://www.youtube.com/watch?v=x91MPoITQ3I](https://youtu.be/oHR6DBvXkU0))**
> Vídeo mostrando las principales funcionalidades de la aplicación web.
...
#### **Alumno 4 - [Claudio Rafael Horrillo Sicora]**

[Desarrollo de OrderRestController, DTO y Mapper,tambien de OrderItem, correciones generales de código y desarrollo de fichero de PostMan]

| Nº    | Commits      | Files      |
|:------------: |:------------:| :------------:|
|1| [OrderRestController.java](URL_commit_1)  | [Archivo1](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/Controller/rest/OrderRestController.java)  |
|2| [OrderDetailDTO.java](URL_commit_2)  | [Archivo2](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/dto/OrderDetailDTO.java)   |
|3| [OrderDetailMapper.java](URL_commit_3)  | [Archivo3](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/dto/OrderDetailMapper.java)   |
|4| [OrderItemDetailDTO.java](URL_commit_4)  | [Archivo4](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/dto/OrderItemDetailDTO.java)  |
|5| [OrderItemDetailMapper.java](URL_commit_5)  | [Archivo5](https://github.com/DWS-2026/project-grupo-13/blob/main/demo/src/main/java/com/example/demo/dto/OrderItemDetailMapper.java)   |
